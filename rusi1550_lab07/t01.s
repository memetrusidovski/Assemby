...
-------------------------------------------------------
*/
STMFD  SP!, {R10, LR}//<----The link register loses track of where the return line is when it goes from the 
//first branch then to the second one, so the line to go back to the top needs to be saved to the stack
